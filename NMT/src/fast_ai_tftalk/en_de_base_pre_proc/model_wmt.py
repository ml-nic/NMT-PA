...
data = load(dpath + 'nmt_datawmt.pkl')
look_ups = load(dpath + 'look_upswmt.pkl')
...
tbCallBack = TensorBoard(log_dir='/data/model_newGraph', histogram_freq=1, write_grads=True, write_graph=True,
                         write_images=True)
modelCallback = ModelCheckpoint(
    'model_checkpoint.{epoch:03d}-{loss:.3f}.hdf5',
...
weight_identifier = "trans_testing_basic_wmt"
