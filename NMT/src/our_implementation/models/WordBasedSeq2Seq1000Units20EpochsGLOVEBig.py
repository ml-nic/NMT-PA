...
class Seq2Seq2(BaseModel):
    def __init__(self):
        ...
        self.identifier = 'WordBasedSeq2Seq1000Units20EpochsGLOVEBig'

        self.params['batch_size'] = 10
        self.params['val_batch_size'] = 32
    ...
    def _setup_model(self, mode=None):
        ...
        self.M.add(LSTM(self.params['latent_dim'] * int(1 / self.params['P_DENSE_DROPOUT']), return_sequences=True))
