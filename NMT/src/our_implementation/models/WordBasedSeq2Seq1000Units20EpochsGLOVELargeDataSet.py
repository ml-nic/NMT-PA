...
class Seq2Seq2(BaseModel):
    def __init__(self):
        ...
        self.identifier = 'WordBasedSeq2Seq1000Units20EpochsGLOVELargeDataSet'

        self.params['batch_size'] = 64
        self.params['val_batch_size'] = 300
        ...
        self.TRAIN_DATA_FILE = os.path.join(self.BASE_DATA_DIR, 'Training/DE_EN_(wmt16_google_nmt)_train.txt')
        self.VAL_DATA_FILE = os.path.join(self.BASE_DATA_DIR, 'Validation/DE_EN_(wmt16_google_nmt)_validation.txt')
    ...
    def _setup_model(self, mode=None):
    ...
    def predict_batch(self, sentences, all_weights=False):
        ...
        if all_weights is True:
            ...
            predictions_for_weights[
                self.LATEST_MODELCHKPT.split('model.')[1]] = self.__predict_batch_for_specific_weight(sentences)
