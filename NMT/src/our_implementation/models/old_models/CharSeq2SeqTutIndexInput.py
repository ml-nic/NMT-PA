...
class Seq2Seq2(BaseModel):
    def __init__(self):
        ...
        self.BASIC_PERSISTENCE_DIR = '../../persistent/' + self.identifier
    ...
    def start_training(self):
        ...
        encoder_input_data = np.zeros((len(input_texts), self.params['max_encoder_seq_length']), dtype='float32')
        decoder_input_data = np.zeros((len(input_texts), self.params['max_decoder_seq_length']), dtype='float32')
