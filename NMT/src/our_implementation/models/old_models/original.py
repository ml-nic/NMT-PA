...
class Original_Charbased():
    def __init__(self):
        self.batch_size = 265  # Batch size for training.
    ...
    def start_training(self):
        ...
        # model = load_model('../../../persistent/model_keras_tut_original/s2s2.h5')
    ...
    def predict_one_sentence(self, sentence):
        ...
        encoder_model = load_model('../../../persistent/model_keras_tut_original/encoder_model.h5')
        ...
        decoder_model = load_model('../../../persistent/model_keras_tut_original/decoder_model.h5')
